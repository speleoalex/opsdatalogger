/**
   ...
   N.A.S.O. datalogger already assembled or in kit available here: https://techmakers.eu/
...
#define MINCONSECUTIVE_POSITIVE 20
#define MQ2_PREHEAT_TIME_S 30
#define MINPPMPOSITIVE 10
